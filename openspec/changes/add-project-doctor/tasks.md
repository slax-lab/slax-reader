...
- [x] 1.1 Add the root `doctor` and `test:doctor` scripts.
...
- [x] 2.1 Document `pnpm run doctor`, its app/profile options, and its backend boundary in the developer guides.
- [x] 2.2 Update the root repository map to include all current shared frontend packages.

## 3. Validation

- [x] 3.1 Run the Doctor unit tests and the command help output.
