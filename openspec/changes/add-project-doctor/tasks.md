...
- [x] 1.7 Label required and declaration-only variables and the conditional backend path; verify missing, empty, invalid, and configured cases retain their existing severity and never print values.
