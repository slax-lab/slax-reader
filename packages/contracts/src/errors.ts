export enum ErrorName {
  ...
  SHARE_COLLECTION_CLOSED = 'SHARE_COLLECTION_CLOSED',
  ...
  REDEEM_CODE_NOT_FOUND_OR_USED = 'REDEEM_CODE_NOT_FOUND_OR_USED',
  BOOKMARK_CHANGES_SYNC_TOO_OLD = 'BOOKMARK_CHANGES_SYNC_TOO_OLD',
  IMPORT_OTHER_TIMEOUT = 'IMPORT_OTHER_TIMEOUT',
  RECEIVE_ACTIVITY_TYPE_NOT_FOUND = 'RECEIVE_ACTIVITY_TYPE_NOT_FOUND',
  RECEIVE_ACTIVITY_ALREADY_RECEIVED = 'RECEIVE_ACTIVITY_ALREADY_RECEIVED',
  HAS_UNFINISHED_IMPORT_TASK = 'HAS_UNFINISHED_IMPORT_TASK',
  TOO_MANY_IMPORT_TASKS = 'TOO_MANY_IMPORT_TASKS',
  READABILITY_PARSE_NO_PARSER = 'READABILITY_PARSE_NO_PARSER',
  READABILITY_PARSE_WEIXIN_CALLBACK_FAIL = 'READABILITY_PARSE_WEIXIN_CALLBACK_FAIL',
  PUPPETEER_TIMEOUT = 'PUPPETEER_TIMEOUT',
  ZYTE_TIMEOUT = 'ZYTE_TIMEOUT',
  WEIXIN_ENV_ABNORMAL = 'WEIXIN_ENV_ABNORMAL',
  DELETE_IMPORT_FAILED_BOOKMARK_FAIL = 'DELETE_IMPORT_FAILED_BOOKMARK_FAIL',
  BOOKMARK_CONTENT_NOT_FOUND = 'BOOKMARK_CONTENT_NOT_FOUND',
  BOOKMARK_OVERVIEW_CONTENT_ERROR = 'BOOKMARK_OVERVIEW_CONTENT_ERROR',
  ACCOUNT_DELETION_NOT_ALLOWED = 'ACCOUNT_DELETION_NOT_ALLOWED',
  USER_ACCOUNT_DELETED = 'USER_ACCOUNT_DELETED',
  APPLE_IAP_PRODUCT_MISMATCH = 'APPLE_IAP_PRODUCT_MISMATCH',
  PLATFORM_ALREADY_BOUND = 'PLATFORM_ALREADY_BOUND',
  OAUTH2_STATE_EXPIRED = 'OAUTH2_STATE_EXPIRED',
  OAUTH2_STATE_INVALID = 'OAUTH2_STATE_INVALID',
  OAUTH2_TOKEN_EXCHANGE_ERROR = 'OAUTH2_TOKEN_EXCHANGE_ERROR',
  OAUTH2_USER_INFO_ERROR = 'OAUTH2_USER_INFO_ERROR',
  PLATFORM_ACCOUNT_BOUND_TO_OTHER_USER = 'PLATFORM_ACCOUNT_BOUND_TO_OTHER_USER',
  INVALID_API_KEY = 'INVALID_API_KEY',
  API_KEY_NOT_FOUND = 'API_KEY_NOT_FOUND',
  API_KEY_REVOKED = 'API_KEY_REVOKED',
  API_KEY_LIMIT_EXCEEDED = 'API_KEY_LIMIT_EXCEEDED',
  API_KEY_ROUTE_NOT_ALLOWED = 'API_KEY_ROUTE_NOT_ALLOWED',
  DAJIALA_ARTICLE_UNAVAILABLE = 'DAJIALA_ARTICLE_UNAVAILABLE',
