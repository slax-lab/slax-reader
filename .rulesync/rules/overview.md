...
- New team members set up their machine with the agent-executable runbook at `docs/LOCAL-SETUP.md`; gitignored local configuration is distributed internally as `local.zip` and restored under `deploy/local/`.
