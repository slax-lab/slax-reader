...
INSERT INTO "new_slax_user_bookmark" ("archive_status", "bookmark_id", "created_at", "id", "is_read", "updated_at", "user_id") SELECT "archive_status", "bookmark_id", "created_at", "id", "is_read", "updated_at", "user_id" FROM "slax_user_bookmark";
