...
INSERT INTO "new_slax_bookmark_share" ("allow_comment", "allow_line", "bookmark_id", "created_at", "id", "share_code", "show_comment", "show_line", "show_userinfo", "user_id") SELECT "allow_comment", "allow_line", "bookmark_id", "created_at", "id", "share_code", "show_comment", "show_line", "show_userinfo", "user_id" FROM "slax_bookmark_share";
