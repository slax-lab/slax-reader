...
SELECT (1);
INSERT INTO "new_slax_user_bookmark_tag" ("bookmark_id", "created_at", "id", "system_tag", "tag_name", "user_id", "tag_id") SELECT "bookmark_id", "created_at", "id", "system_tag", "tag_name", "user_id", 0 as "tag_id" FROM "slax_user_bookmark_tag";
