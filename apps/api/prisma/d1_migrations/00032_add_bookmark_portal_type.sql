...
INSERT INTO "new_slax_user_bookmark" ("alias_title", "archive_status", "bookmark_id", "created_at", "deleted_at", "id", "is_read", "is_starred", "updated_at", "user_id") SELECT "alias_title", "archive_status", "bookmark_id", "created_at", "deleted_at", "id", "is_read", "is_starred", "updated_at", "user_id" FROM "slax_user_bookmark";
...
CREATE INDEX "slax_user_bookmark_user_id_deleted_at_idx" ON "slax_user_bookmark"("user_id", "deleted_at");
