...
INSERT INTO "new_slax_mark_comment" ("bookmark_id", "comment", "content", "created_at", "id", "is_deleted", "parent_id", "root_id", "source", "type", "updated_at", "user_id") SELECT "bookmark_id", "comment", "content", "created_at", "id", "is_deleted", "parent_id", "root_id", "source", "type", "updated_at", "user_id" FROM "slax_mark_comment";
