/* eslint-disable */
// Env bindings are maintained manually without configuration values; pnpm types refreshes runtime types only.
interface __BaseEnv_Env {
  API_QUEUE_CHANNELS?: string
  KV: KVNamespace
  OSS: R2Bucket
  DB: D1Database
  ...
  HYPERDRIVE_LOGS: Hyperdrive
  TWITTER_PARSER: Queue
  FETCH_RETRY_PARSER: Queue
  STRIPE_QUEUE: Queue
  IMPORT_OTHER: Queue
  IMPORT_OTHER_SLOW: Queue
  USER_DELETION_QUEUE: Queue
  BOOKMARK_ADD_RATE_LIMITER: RateLimit
  BROWSER: BrowserRun
  AI: Ai
  SLAX_READER_STREAM_STREAM: import('cloudflare:pipelines').Pipeline<import('cloudflare:pipelines').PipelineRecord>
  RUN_ENV: string
  RUN_TYPE: string
  WHITE_EMAILS?: string
  ...
  JWT_EXPIRES: string
  JWT_ISSUER: string
  APPLE_SIGN_KEY_ID: string
  APPLE_SIGN_TEAM_ID: string
  APPLE_WEB_CLIENT_ID?: string
  APPLE_NATIVE_CLIENT_IDS?: string
  OAUTH_AUTH_BASE_URL?: string
  IMAGER_CHECK_DIGST_SALT: string
  IMAGE_PREFIX: string
  PROXY_IMAGE_PREFIX: string
  STRIPE_SUBSCRIPTION_HOME: string
  SLAX_READER_BOT_NAME: string
  SLAX_READER_BOT_ID: string
  SLAX_READER_BOT_API_ROOT: string
  FRONT_END_URL: string
  GEMINI_BATCH_API_URL: string
  POWERSYNC_SG_API_URL: string
  BACKEND_API_PREFIX: string
  X_CLIENT_ID: string
  X_CLIENT_CALLBACK_URL: string
  TWITTER_MONITORING_USERNAME: string
  REPORT_PUSH_API?: string
  STRIPE_PUSH_API?: string
  ERROR_LOG_PUSH_API?: string
  CRAWL_PUSH_API?: string
  ...
  GOOGLE_IOS_CLIENT_ID_TEXT: string
  GOOGLE_ANDROID_CLIENT_ID_TEXT: string
  APPLE_SIGN_AUTH_KEY: string
  APIFY_API_TOKEN: string
  STRIPE_SECRET_KEY: string
  STRIPE_LIVE_MODE?: string
  STRIPE_CALLBACK_SECRET: string
  TURNSTILE_PAYMENT_SECRET_KEY: string
  JINA_API_KEY: string
  UPSTASH_REDIS_REST_TOKEN: string
  UPSTASH_REDIS_REST_URL: string
  ZYTE_API_KEY: string
  SCRAPING_BOT_TOKEN: string
  GEMINI_BATCH_API_KEY: string
  APP_STORE_API_PRIVATE_KEY: string
  APP_STORE_BUNDLE_ID: string
  APP_STORE_ISSUER_ID: string
  APP_STORE_API_KEY_ID: string
  TIKHUB_TOKEN: string
  X_CLIENT_SECRET: string
  VERTEX_API_KEY: string
  JIZHILE_API_KEY: string
  POWERSYNC_JWK_PRIVATE_KEY: string
  OPENAI_MODERATION_KEYS: string
  SLAX_JIEBA: DurableObjectNamespace<import('./src/entry/core/index').SlaxJieba>
  WEBSOCKET_SERVER: DurableObjectNamespace<import('./src/entry/core/index').SlaxWebSocketServer>
  SLAX_BROWSER: DurableObjectNamespace /* SlaxBrowser from browser-backend */
  SCREENSHOT_BROWSER: DurableObjectNamespace<import('./src/entry/core/index').ScreenshotBrowser>
  SlaxBrowser: Fetcher /* browser-backend */
  SlaxTwitterFxembed: Fetcher /* fxembed */
  AIGC: Fetcher /* reader-ai */
  VECTOR: Service /* entrypoint AiEntry from reader-ai */
  CORE: Service<typeof import('./src/entry/core/index').default>
  CRAWL_WORKFLOW: Workflow /* CrawlWorkflow from reader-core */
  CONTENT_VALIDATION_WORKFLOW: Workflow /* ContentValidationWorkflow from reader-core */
  IMPORT_PARSE_WORKFLOW: Workflow /* ImportParseWorkflow from reader-core */
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/entry/core/index')
  }
