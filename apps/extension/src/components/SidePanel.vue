...
import { type AddBookmarkReq, type BookmarkBriefDetail, type MarkDetail, type MarkInfo, MarkType as BackendMarkType, type UserInfo } from '@slax-reader/contracts/interface'
