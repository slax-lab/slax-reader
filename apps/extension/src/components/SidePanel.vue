...
import { type AddBookmarkReq, type BookmarkBriefDetail, type MarkDetail, type MarkInfo, MarkType as BackendMarkType, type UserInfo } from '@commons/contracts/interface'
