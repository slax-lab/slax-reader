...
import { type AddBookmarkReq, MarkType as BackendMarkType, type UserInfo } from '@slax-reader/contracts/interface'
import type { BookmarkBriefDetail, MarkDetail, MarkInfo } from '@commons/frontend-types/models'
