...
import type { MarkDetail } from '@commons/contracts/interface'
...
import { useArticleSelection } from '~/composables/bookmark/useArticleSelection'
...
@use '~~/styles/article/github-light.css' as *;
